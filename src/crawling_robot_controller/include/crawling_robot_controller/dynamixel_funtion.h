...
void SET_dynamixel() 
{
    ...
    packetHandler->write1ByteTxRx(portHandler, BASE_MOTOR, ADDR_SHUTDOWN, 0x00, nullptr);
    packetHandler->write1ByteTxRx(portHandler, XC330_DXL_ID, ADDR_SHUTDOWN, 0x00, nullptr);
    packetHandler->write1ByteTxRx(portHandler, EE_MOTOR, ADDR_SHUTDOWN, 0x00, nullptr);
}
