...
struct DynamixelCommandRequest_
{
  ...
  _command_type command;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _addr_name_type;
...
struct Printer< ::dynamixel_workbench_msgs::DynamixelCommandRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_workbench_msgs::DynamixelCommandRequest_<ContainerAllocator>& v)
  {
    ...
    s << indent << "addr_name: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.addr_name);
    s << indent << "value: ";
