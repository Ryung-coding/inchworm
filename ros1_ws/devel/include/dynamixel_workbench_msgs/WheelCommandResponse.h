...
bool operator==(const ::dynamixel_workbench_msgs::WheelCommandResponse_<ContainerAllocator1> & lhs, const ::dynamixel_workbench_msgs::WheelCommandResponse_<ContainerAllocator2> & rhs)
{
